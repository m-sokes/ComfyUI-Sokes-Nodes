...
| Node | Description |
| --- | --- |
| **Current Date & Time with Custom Formatting** | Add the current date to the filename. E.g. YYYY-MM-DD<br /><h6>Tip: Also supports python formated dates & time properties</h6> |
